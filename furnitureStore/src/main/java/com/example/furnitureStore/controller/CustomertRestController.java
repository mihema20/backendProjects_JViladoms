 ...
 * 
 * import com.example.furnitureStore.model.Customer; import
 * com.example.furnitureStore.service.CustomerUserDetailService;
 * 
 * @RestController //@RequestMapping("/apiCustomer") public class
 * CustomertRestController {
 * 
 ...
 * model.addAttribute("customer", new Customer()); return "formRegister"; }
 * 
 * @PostMapping("/addUser") public String
 * submissionResult(@ModelAttribute("customerForm") Customer person) {
 * System.out.println("*************************"+person.getUsername()); return
 * "result"; }
 * 
 * 
 * /*
